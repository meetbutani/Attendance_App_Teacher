...
import com.meetbutani.attendanceapp_teacher.AdapterClass.AdapterCourse;
...
public class CourseFragment extends BaseFragment {
    ...
    protected void displayCourses() {
        try {
            ...
            firebaseFirestore.collection(TEACHERPATH + "/" + getUid() + "/courses").orderBy("courseName", Query.Direction.ASCENDING).get()
