...
public class RegisterActivity extends BaseActivity {
    ...
    private TextInputLayout etErRegisterFirstName, etErRegisterLastName, etErRegisterEmail, etErRegisterPassword, etErRegisterConfirmPassword;
    private TextInputEditText etRegisterFirstName, etRegisterLastName, etRegisterEmail, etRegisterPassword, etRegisterConfirmPassword;
        ...
        if (valid) {
            ...
            firebaseAuth.createUserWithEmailAndPassword(email, password).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                ...
                public void onSuccess(AuthResult authResult) {
                    ...
                    if (imageUri != null) {
                        StorageReference imageStorageRef = storageReference.child("Teacher Profile Pic/" + getUid());
                ...
                private void storeData(String uri) {
                    ...
                    firebaseFirestore.collection(TEACHERPATH).document(getUid())
